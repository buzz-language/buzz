...
fn handleSpawnError(ctx: *api.NativeCtx, err: anytype) void {
    switch (err) {
        ...
        error.InvalidFileDescriptor => ctx.vm.pushErrorEnum("lib.errors.ExecError", "InvalidFileDescriptor"),
        ...
        error.ChildExecFailed => ctx.vm.pushErrorEnum("lib.errors.ExecError", "ChildExecFailed"),
        ...
        error.TooBig => ctx.vm.pushErrorEnum("lib.errors.ExecError", "TooBig"),
