...
pub const Value = extern struct {
    ...
    pub extern fn bz_valueToString(value: Value, len: *usize, vm: *VM) callconv(.c) ?[*]const u8;
    pub extern fn bz_valueToCString(value: Value, vm: *VM) callconv(.c) ?[*:0]const u8;
    pub extern fn bz_valueToForeignContainerPtr(value: Value, vm: *VM) callconv(.c) [*]u8;
    pub extern fn bz_valueIsForeignContainer(value: Value, vm: *VM) callconv(.c) bool;
    pub extern fn bz_valueDump(value: Value, vm: *VM) callconv(.c) void;
    pub extern fn bz_valueEqual(self: Value, other: Value, vm: *VM) callconv(.c) Value;
    pub extern fn bz_rangeContains(range: Value, value: Value, vm: *VM) callconv(.c) Value;
    pub extern fn bz_patternMatches(vm: *VM, pattern: Value, subject: Value) callconv(.c) Value;
    pub extern fn bz_valueIs(self: Value, type_def: Value, vm: *VM) callconv(.c) Value;
    pub extern fn bz_valueTypeOf(self: Value, vm: *VM) callconv(.c) Value;
    pub extern fn bz_getUserDataPtr(userdata: Value, vm: *VM) callconv(.c) u64;
    pub extern fn bz_containerTypeSize(container: Value, vm: *VM) callconv(.c) usize;
    pub extern fn bz_containerTypeAlign(type_def: Value, vm: *VM) callconv(.c) usize;
    ...
    pub extern fn bz_rangeNext(range_value: Value, index_slot: Value, vm: *VM) callconv(.c) Value;
    ...
    pub extern fn bz_listGet(list: Value, index: i64, checked: bool, vm: *VM) callconv(.c) Value;
    pub extern fn bz_listSet(list: Value, index: usize, value: Value, vm: *VM) callconv(.c) void;
    pub extern fn bz_listLen(list: Value, vm: *VM) callconv(.c) usize;
    ...
    pub extern fn bz_mapGet(map: Value, key: Value, vm: *VM) callconv(.c) Value;
    pub extern fn bz_mapConcat(map: Value, other_map: Value, vm: *VM) callconv(.c) Value;
    pub extern fn bz_mapNext(map_value: Value, index: *Value, vm: *VM) callconv(.c) Value;
    ...
    pub extern fn bz_getObjectInstanceProperty(instance_value: Value, property_idx: usize, vm: *VM) callconv(.c) Value;
    ...
    pub extern fn bz_getObjectField(object_value: Value, field_idx: usize, vm: *VM) callconv(.c) Value;
    pub extern fn bz_setObjectField(object_value: Value, field_idx: usize, value: Value, vm: *VM) callconv(.c) void;
    pub extern fn bz_getEnumInstanceValue(enum_instance_value: Value, vm: *VM) callconv(.c) Value;
    ...
    pub extern fn bz_foreignContainerSlice(container_value: Value, len: *usize, vm: *VM) callconv(.c) [*]u8;
};
