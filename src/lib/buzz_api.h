...
const uint8_t *bz_valueToString(Value value, size_t *len, VM *vm);
const char *bz_valueToCString(Value value, VM *vm);
uint8_t *bz_valueToForeignContainerPtr(Value value, VM *vm);
bool bz_valueIsForeignContainer(Value value, VM *vm);
void bz_valueDump(Value value, VM *vm);
Value bz_valueEqual(Value self, Value other, VM *vm);
Value bz_rangeContains(Value range, Value value, VM *vm);
Value bz_patternMatches(VM *vm, Value pattern, Value subject);
Value bz_valueIs(Value self, Value type_def, VM *vm);
Value bz_valueTypeOf(Value self, VM *vm);
uint64_t bz_getUserDataPtr(Value userdata, VM *vm);
size_t bz_containerTypeSize(Value container, VM *vm);
size_t bz_containerTypeAlign(Value type_def, VM *vm);
...
Value bz_rangeNext(Value range_value, Value index_slot, VM *vm);
...
Value bz_listGet(Value list, int64_t index, bool checked, VM *vm);
void bz_listSet(Value list, size_t index, Value value, VM *vm);
size_t bz_listLen(Value list, VM *vm);
...
Value bz_mapGet(Value map, Value key, VM *vm);
Value bz_mapConcat(Value map, Value other_map, VM *vm);
Value bz_mapNext(Value map_value, Value *index, VM *vm);
void bz_setObjectInstanceProperty(Value instance_value, size_t property_idx, Value value, VM *vm);
Value bz_getObjectInstanceProperty(Value instance_value, size_t property_idx, VM *vm);
...
Value bz_getObjectField(Value object_value, size_t field_idx, VM *vm);
void bz_setObjectField(Value object_value, size_t field_idx, Value value, VM *vm);
Value bz_getEnumInstanceValue(Value enum_instance_value, VM *vm);
...
uint8_t *bz_foreignContainerSlice(Value container_value, size_t *len, VM *vm);
