...
pub extern fn MIR_new_import(ctx: MIR_context_t, name: [*:0]const u8) callconv(.c) MIR_item_t;
pub extern fn MIR_new_export(ctx: MIR_context_t, name: [*:0]const u8) callconv(.c) MIR_item_t;
pub extern fn MIR_new_forward(ctx: MIR_context_t, name: [*:0]const u8) callconv(.c) MIR_item_t;
pub extern fn MIR_new_bss(ctx: MIR_context_t, name: [*:0]const u8, len: usize) callconv(.c) MIR_item_t;
pub extern fn MIR_new_data(ctx: MIR_context_t, name: [*:0]const u8, el_type: MIR_type_t, nel: usize, els: ?*const anyopaque) callconv(.c) MIR_item_t;
pub extern fn MIR_new_string_data(ctx: MIR_context_t, name: [*:0]const u8, str: MIR_str_t) callconv(.c) MIR_item_t;
pub extern fn MIR_new_ref_data(ctx: MIR_context_t, name: [*:0]const u8, item: MIR_item_t, disp: i64) callconv(.c) MIR_item_t;
pub extern fn MIR_new_lref_data(ctx: MIR_context_t, name: [*:0]const u8, label: MIR_label_t, label2: MIR_label_t, disp: i64) callconv(.c) MIR_item_t;
pub extern fn MIR_new_expr_data(ctx: MIR_context_t, name: [*:0]const u8, expr_item: MIR_item_t) callconv(.c) MIR_item_t;
pub extern fn MIR_new_proto_arr(ctx: MIR_context_t, name: [*:0]const u8, nres: usize, res_types: ?[*]const MIR_type_t, nargs: usize, vars: ?[*]const MIR_var_t) callconv(.c) MIR_item_t;
pub extern fn MIR_new_vararg_proto_arr(ctx: MIR_context_t, name: [*:0]const u8, nres: usize, res_types: *MIR_type_t, nargs: usize, vars: *MIR_var_t) callconv(.c) MIR_item_t;
pub extern fn MIR_new_func_arr(ctx: MIR_context_t, name: [*:0]const u8, nres: usize, res_types: ?[*]const MIR_type_t, nargs: usize, vars: [*]const MIR_var_t) callconv(.c) MIR_item_t;
pub extern fn MIR_new_vararg_func_arr(ctx: MIR_context_t, name: [*:0]const u8, nres: usize, res_types: *MIR_type_t, nargs: usize, vars: *MIR_var_t) callconv(.c) MIR_item_t;
pub extern fn MIR_item_name(ctx: MIR_context_t, item: MIR_item_t) callconv(.c) [*:0]const u8;
pub extern fn MIR_get_item_func(ctx: MIR_context_t, item: MIR_item_t) callconv(.c) MIR_func_t;
pub extern fn MIR_new_func_reg(ctx: MIR_context_t, func: MIR_func_t, @"type": MIR_type_t, name: [*:0]const u8) callconv(.c) MIR_reg_t;
pub extern fn MIR_new_global_func_reg(ctx: MIR_context_t, func: MIR_func_t, @"type": MIR_type_t, name: [*:0]const u8, hard_reg_name: [*:0]const u8) callconv(.c) MIR_reg_t;
pub extern fn MIR_finish_func(ctx: MIR_context_t) callconv(.c) void;
pub extern fn MIR_finish_module(ctx: MIR_context_t) callconv(.c) void;
pub extern fn MIR_get_error_func(ctx: MIR_context_t) callconv(.c) MIR_error_func_t;
pub extern fn MIR_set_error_func(ctx: MIR_context_t, func: MIR_error_func_t) callconv(.c) void;
pub extern fn MIR_get_func_redef_permission_p(ctx: MIR_context_t) callconv(.c) c_int;
pub extern fn MIR_set_func_redef_permission(ctx: MIR_context_t, flag_p: c_int) callconv(.c) void;
pub extern fn MIR_new_insn_arr(ctx: MIR_context_t, code: MIR_insn_code_t, nops: usize, ops: [*]const MIR_op_t) callconv(.c) MIR_insn_t;
pub extern fn MIR_copy_insn(ctx: MIR_context_t, insn: MIR_insn_t) callconv(.c) MIR_insn_t;
pub extern fn MIR_insn_name(ctx: MIR_context_t, code: MIR_insn_code_t) callconv(.c) [*:0]const u8;
pub extern fn MIR_insn_nops(ctx: MIR_context_t, insn: MIR_insn_t) callconv(.c) usize;
pub extern fn MIR_insn_op_mode(ctx: MIR_context_t, insn: MIR_insn_t, nop: usize, out_p: *c_int) callconv(.c) MIR_op_mode_t;
pub extern fn MIR_new_label(ctx: MIR_context_t) callconv(.c) MIR_insn_t;
pub extern fn MIR_reg(ctx: MIR_context_t, reg_name: [*:0]const u8, func: MIR_func_t) callconv(.c) MIR_reg_t;
pub extern fn MIR_reg_type(ctx: MIR_context_t, reg: MIR_reg_t, func: MIR_func_t) callconv(.c) MIR_type_t;
pub extern fn MIR_reg_name(ctx: MIR_context_t, reg: MIR_reg_t, func: MIR_func_t) callconv(.c) [*:0]const u8;
pub extern fn MIR_hard_reg_name(ctx: MIR_context_t, reg: MIR_reg_t, func: MIR_func_t) callconv(.c) [*:0]const u8;
pub extern fn MIR_alias_name(ctx: MIR_context_t, alias: MIR_alias_t) callconv(.c) [*:0]const u8;
pub extern fn MIR_alias(ctx: MIR_context_t, name: [*:0]const u8) callconv(.c) MIR_alias_t;
pub extern fn MIR_new_reg_op(ctx: MIR_context_t, reg: MIR_reg_t) callconv(.c) MIR_op_t;
pub extern fn MIR_new_int_op(ctx: MIR_context_t, v: i64) callconv(.c) MIR_op_t;
pub extern fn MIR_new_uint_op(ctx: MIR_context_t, v: u64) callconv(.c) MIR_op_t;
pub extern fn MIR_new_float_op(ctx: MIR_context_t, v: f32) callconv(.c) MIR_op_t;
pub extern fn MIR_new_double_op(ctx: MIR_context_t, v: f64) callconv(.c) MIR_op_t;
pub extern fn MIR_new_ldouble_op(ctx: MIR_context_t, v: c_longdouble) callconv(.c) MIR_op_t;
pub extern fn MIR_new_ref_op(ctx: MIR_context_t, item: MIR_item_t) callconv(.c) MIR_op_t;
pub extern fn MIR_new_str_op(ctx: MIR_context_t, str: MIR_str_t) callconv(.c) MIR_op_t;
...
pub extern fn MIR_new_label_op(ctx: MIR_context_t, label: MIR_label_t) callconv(.c) MIR_op_t;
pub extern fn MIR_op_eq_p(ctx: MIR_context_t, op1: MIR_op_t, op2: MIR_op_t) callconv(.c) c_int;
pub const htab_hash_t = c_uint;
pub extern fn MIR_op_hash_step(ctx: MIR_context_t, h: htab_hash_t, op: MIR_op_t) callconv(.c) htab_hash_t;
pub extern fn MIR_append_insn(ctx: MIR_context_t, func: MIR_item_t, insn: MIR_insn_t) callconv(.c) void;
pub extern fn MIR_prepend_insn(ctx: MIR_context_t, func: MIR_item_t, insn: MIR_insn_t) callconv(.c) void;
pub extern fn MIR_insert_insn_after(ctx: MIR_context_t, func: MIR_item_t, after: MIR_insn_t, insn: MIR_insn_t) callconv(.c) void;
pub extern fn MIR_insert_insn_before(ctx: MIR_context_t, func: MIR_item_t, before: MIR_insn_t, insn: MIR_insn_t) callconv(.c) void;
pub extern fn MIR_remove_insn(ctx: MIR_context_t, func: MIR_item_t, insn: MIR_insn_t) callconv(.c) void;
pub extern fn MIR_change_module_ctx(old_ctx: MIR_context_t, m: MIR_module_t, new_ctx: MIR_context_t) callconv(.c) void;
pub extern fn MIR_reverse_branch_code(code: MIR_insn_code_t) callconv(.c) MIR_insn_code_t;
pub extern fn MIR_type_str(ctx: MIR_context_t, tp: MIR_type_t) callconv(.c) [*:0]const u8;
pub extern fn MIR_output_str(ctx: MIR_context_t, f: ?*std.c.FILE, str: MIR_str_t) callconv(.c) void;
pub extern fn MIR_output_op(ctx: MIR_context_t, f: ?*std.c.FILE, op: MIR_op_t, func: MIR_func_t) callconv(.c) void;
pub extern fn MIR_output_insn(ctx: MIR_context_t, f: ?*std.c.FILE, insn: MIR_insn_t, func: MIR_func_t, newline_p: c_int) callconv(.c) void;
pub extern fn MIR_output_item(ctx: MIR_context_t, f: ?*std.c.FILE, item: MIR_item_t) callconv(.c) void;
pub extern fn MIR_output_module(ctx: MIR_context_t, f: ?*std.c.FILE, module: MIR_module_t) callconv(.c) void;
pub extern fn MIR_output(ctx: MIR_context_t, f: ?*std.c.FILE) callconv(.c) void;
pub extern fn MIR_write(ctx: MIR_context_t, f: ?*std.c.FILE) callconv(.c) void;
pub extern fn MIR_write_module(ctx: MIR_context_t, f: ?*std.c.FILE, module: MIR_module_t) callconv(.c) void;
pub extern fn MIR_read(ctx: MIR_context_t, f: ?*std.c.FILE) callconv(.c) void;
...
pub extern fn MIR_scan_string(ctx: MIR_context_t, str: [*:0]const u8) callconv(.c) void;
...
pub extern fn MIR_gen_set_optimize_level(ctx: MIR_context_t, level: c_uint) callconv(.c) void;
pub extern fn MIR_gen(ctx: MIR_context_t, func_item: MIR_item_t) callconv(.c) ?*anyopaque;
pub extern fn MIR_set_gen_interface(ctx: MIR_context_t, func_item: MIR_item_t) callconv(.c) void;
pub extern fn MIR_set_parallel_gen_interface(ctx: MIR_context_t, func_item: MIR_item_t) callconv(.c) void;
pub extern fn MIR_set_lazy_gen_interface(ctx: MIR_context_t, func_item: MIR_item_t) callconv(.c) void;
pub extern fn MIR_gen_finish(ctx: MIR_context_t) callconv(.c) void;
