...
pub const ExternApi = enum {
    ...
    pub fn ptr(self: ExternApi) *anyopaque {
        return @as(
            *anyopaque,
            @ptrFromInt(
                switch (self) {
                    .bz_toString => @intFromPtr(&api.ObjString.bz_toString),
                    .bz_objStringConcat => @intFromPtr(&api.ObjString.bz_objStringConcat),
                    .bz_objStringSubscript => @intFromPtr(&api.ObjString.bz_objStringSubscript),
                    .bz_stringNext => @intFromPtr(&api.ObjString.bz_stringNext),
                    .bz_newList => @intFromPtr(&api.ObjList.bz_newList),
                    .bz_newRange => @intFromPtr(&api.ObjRange.bz_newRange),
                    .bz_rangeNext => @intFromPtr(&api.ObjRange.bz_rangeNext),
                    .bz_listAppend => @intFromPtr(&api.ObjList.bz_listAppend),
                    .bz_listGet => @intFromPtr(&api.ObjList.bz_listGet),
                    .bz_listSet => @intFromPtr(&api.ObjList.bz_listSet),
                    .bz_listConcat => @intFromPtr(&api.ObjList.bz_listConcat),
                    .bz_listNext => @intFromPtr(&api.ObjList.bz_listNext),
                    .bz_newMap => @intFromPtr(&api.ObjMap.bz_newMap),
                    .bz_mapGet => @intFromPtr(&api.ObjMap.bz_mapGet),
                    .bz_mapSet => @intFromPtr(&api.ObjMap.bz_mapSet),
                    .bz_mapNext => @intFromPtr(&api.ObjMap.bz_mapNext),
                    .bz_mapConcat => @intFromPtr(&api.ObjMap.bz_mapConcat),
                    .bz_valueEqual => @intFromPtr(&api.Value.bz_valueEqual),
                    .bz_valueIs => @intFromPtr(&api.Value.bz_valueIs),
                    .bz_closure => @intFromPtr(&api.VM.bz_closure),
                    .bz_context => @intFromPtr(&api.VM.bz_context),
                    .bz_instance => @intFromPtr(&api.ObjObject.bz_instance),
                    .bz_setInstanceField => @intFromPtr(&api.ObjObject.bz_setInstanceField),
                    .bz_getInstanceField => @intFromPtr(&api.ObjObject.bz_getInstanceField),
                    .bz_rethrow => @intFromPtr(&api.VM.bz_rethrow),
                    .bz_throw => @intFromPtr(&api.VM.bz_throw),
                    .bz_bindMethod => @intFromPtr(&api.VM.bz_bindMethod),
                    .bz_getUpValue => @intFromPtr(&api.VM.bz_getUpValue),
                    .bz_setUpValue => @intFromPtr(&api.VM.bz_setUpValue),
                    .bz_closeUpValues => @intFromPtr(&api.VM.bz_closeUpValues),
                    .bz_clone => @intFromPtr(&api.VM.bz_clone),
                    .bz_dumpStack => @intFromPtr(&api.VM.bz_dumpStack),
                    .bz_getEnumCaseFromValue => @intFromPtr(&api.ObjEnum.bz_getEnumCaseFromValue),
                    .bz_getEnumCase => @intFromPtr(&api.ObjEnum.bz_getEnumCase),
                    .bz_enumNext => @intFromPtr(&api.ObjEnum.bz_enumNext),
                    .bz_getEnumCaseValue => @intFromPtr(&api.ObjEnumInstance.bz_getEnumCaseValue),
                    .bz_setObjectField => @intFromPtr(&api.ObjObject.bz_setObjectField),
                    .bz_getObjectField => @intFromPtr(&api.ObjObject.bz_getObjectField),
                    .bz_getListField => @intFromPtr(&api.ObjList.bz_getListField),
                    .bz_getMapField => @intFromPtr(&api.ObjMap.bz_getMapField),
                    .bz_getRangeField => @intFromPtr(&api.ObjRange.bz_getRangeField),
                    .bz_getStringField => @intFromPtr(&api.ObjString.bz_getStringField),
                    .bz_getPatternField => @intFromPtr(&api.ObjPattern.bz_getPatternField),
                    .bz_getFiberField => @intFromPtr(&api.ObjFiber.bz_getFiberField),
                    .bz_setTryCtx => @intFromPtr(&api.VM.bz_setTryCtx),
                    .bz_popTryCtx => @intFromPtr(&api.VM.bz_popTryCtx),
                    .bz_valueToCString => @intFromPtr(&api.Value.bz_valueToCString),
                    .bz_valueToUserData => @intFromPtr(&api.Value.bz_valueToUserData),
                    .bz_userDataToValue => @intFromPtr(&api.ObjUserData.bz_userDataToValue),
                    .bz_valueToForeignContainerPtr => @intFromPtr(&api.Value.bz_valueToForeignContainerPtr),
                    .bz_stringZ => @intFromPtr(&api.ObjString.bz_stringZ),
                    .bz_containerGet => @intFromPtr(&api.ObjForeignContainer.bz_containerGet),
                    .bz_containerSet => @intFromPtr(&api.ObjForeignContainer.bz_containerSet),
                    .bz_containerInstance => @intFromPtr(&api.ObjForeignContainer.bz_containerInstance),
                    .bz_valueTypeOf => @intFromPtr(&api.Value.bz_valueTypeOf),
                    .bz_containerFromSlice => @intFromPtr(&api.ObjForeignContainer.bz_containerFromSlice),
                    .memcpy => @intFromPtr(&api.bz_memcpy),
                    .setjmp => @intFromPtr(
                        &(if (builtin.os.tag == .macos or builtin.os.tag == .linux or builtin.os.tag == .windows) jmp._setjmp else jmp.setjmp),
                    ),
                    .exit => @intFromPtr(&bz_exit),

                    .dumpInt => @intFromPtr(&api.dumpInt),
                    .bz_valueDump => @intFromPtr(&api.Value.bz_valueDump),
                    else => {
                        std.debug.print("{s}\n", .{self.name()});
                        unreachable;
                    },
    ...
    pub fn name(self: ExternApi) [*:0]const u8 {
        return switch (self) {
            ...
            .bz_getRangeField => "bz_getRangeField",
    ...
    pub fn pname(self: ExternApi) [*:0]const u8 {
        return switch (self) {
            ...
            .bz_getRangeField => "p_bz_getRangeField",
