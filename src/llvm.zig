...
pub const GenericValue = opaque {};

pub const MCJITMemoryManager = opaque {};

pub const MCJITCompilerOptions = extern struct {
    OptLevel: c_uint,
    CodeModel: CodeModel,
    ...
    pub const initialize = LLVMInitializeMCJITCompilerOptions;
    extern fn LLVMInitializeMCJITCompilerOptions(Options: *MCJITCompilerOptions, SizeOfOptions: usize) void;
};

pub const ExecutionEngine = opaque {
    pub const createMCJITCompilerForModule = LLVMCreateMCJITCompilerForModule;
    extern fn LLVMCreateMCJITCompilerForModule(
        OutJIT: **ExecutionEngine,
        M: *Module,
    ...
    pub const dispose = LLVMDisposeExecutionEngine;
    extern fn LLVMDisposeExecutionEngine(EE: *ExecutionEngine) void;

    pub const runFunction = LLVMRunFunction;
    extern fn LLVMRunFunction(
        EE: *ExecutionEngine,
        F: *Value,
        NumArgs: c_uint,
        [*]*GenericValue,
    ...
    pub const runFunctionAsMain = LLVMRunFunctionAsMain;
    extern fn LLVMRunFunctionAsMain(
        EE: *ExecutionEngine,
        F: *Value,
        ArcG: c_uint,
        ArgV: [*][*:0]const u8,
    ...
    pub const getFunctionAddress = LLVMGetFunctionAddress;
    extern fn LLVMGetFunctionAddress(
        EE: *ExecutionEngine,
        Name: [*:0]const u8,
    ) u64;
};

// MCJIT: seems like the old JIT API
pub extern fn LLVMLinkInMCJIT() void;

// LLJIT & ORC
pub const LLVMError = opaque {
    pub const getErrorMessage = LLVMGetErrorMessage;
    extern fn LLVMGetErrorMessage(Err: *LLVMError) [*:0]const u8;
};
...
pub const OrcLLJIT = opaque {
    ...
    extern fn LLVMOrcLLJITAddLLVMIRModule(
        J: *OrcLLJIT,
        JD: *OrcJITDylib,
    ...
    extern fn LLVMOrcLLJITGetMainJITDylib(J: *OrcLLJIT) *OrcJITDylib;

    pub const dispose = LLVMOrcDisposeLLJIT;
    extern fn LLVMOrcDisposeLLJIT(J: *OrcLLJIT) ?*LLVMError;
...
pub const OrcLLJITBuilder = opaque {
    ...
    pub const createOrcLLJIT = LLVMOrcCreateLLJIT;
    extern fn LLVMOrcCreateLLJIT(Result: **OrcLLJIT, Builder: *OrcLLJITBuilder) ?*LLVMError;

    pub const dispose = LLVMOrcDisposeLLJITBuilder;
    extern fn LLVMOrcDisposeLLJITBuilder(Builder: *OrcLLJITBuilder) void;

    pub const setJITTargetMachineBuilder = LLVMOrcLLJITBuilderSetJITTargetMachineBuilder;
    extern fn LLVMOrcLLJITBuilderSetJITTargetMachineBuilder(Builder: *OrcLLJITBuilder, JTMB: *OrcJITTargetMachineBuilder) void;
};

pub const OrcJITTargetMachineBuilder = opaque {
    pub const detectHost = LLVMOrcJITTargetMachineBuilderDetectHost;
    extern fn LLVMOrcJITTargetMachineBuilderDetectHost(Result: **OrcJITTargetMachineBuilder) ?*LLVMError;

    pub const getTargetTriple = LLVMOrcJITTargetMachineBuilderGetTargetTriple;
    extern fn LLVMOrcJITTargetMachineBuilderGetTargetTriple(JTMB: *OrcJITTargetMachineBuilder) [*:0]const u8;

    pub const dispose = LLVMOrcDisposeJITTargetMachineBuilder;
    extern fn LLVMOrcDisposeJITTargetMachineBuilder(JTMB: *OrcJITTargetMachineBuilder) void;
};
