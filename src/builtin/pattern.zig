...
pub fn rawMatch(self: *o.ObjPattern, vm: *VM, subject: *o.ObjString, offset: *usize) !?*o.ObjList {
                        ...
                        .{
                            ...
                            .resolved_type = .{
                                .List = o.ObjList.ListDef.init(
                                    vm.gc.get(o.ObjTypeDef, vm.gc.type_registry.str_type),
                                    false,
                                ),
                            },
                        },
                ...
                try o.ObjList.init(
                    ...
                    try vm.gc.type_registry.getTypeDef(
                        .{
                            ...
                            .resolved_type = .{
                                .List = o.ObjList.ListDef.init(
                                    vm.gc.get(o.ObjTypeDef, matches.type_def),
                                    false,
                                ),
                            },
                        },
